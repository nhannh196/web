export const MenuManage = [
  //Dashboard
  {
    ...
    iconStyle: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-house-door" viewBox="0 0 16 16">
  ...
  //Forum
  {
    title: "Forum",
    classsChange: "mm-collapse",
    iconStyle: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-newspaper" viewBox="0 0 16 16">
  ...
  //New Posts
  {
    title: 'List New Posts',
    classsChange: 'mm-collapse',
    iconStyle: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-earmark-plus" viewBox="0 0 16 16">
  ...
  //List Posts
  {
    title: 'Manage Posts',
    classsChange: 'mm-collapse',
    iconStyle: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-journal" viewBox="0 0 16 16">
  ...
  //List Stock Code
  // {
  //   title: 'List Stocks Code',
  //   classsChange: 'mm-collapse',
  //   iconStyle: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-list-columns" viewBox="0 0 16 16">
