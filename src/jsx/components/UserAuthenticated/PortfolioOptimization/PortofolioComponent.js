...
const PortofolioComponent = () => {
  ...
  const [loadingOptimizePortofolioView, setLoadingOptimizePortofolioView] =
    useState(false);
  //loading Stock Investment Portofolio
  const [
    loadingStockInvestmentPortofolio,
    setLoadingStockInvestmentPortofolio,
  ] = useState(false);
  //Desired quantity
  ...
  const dataStocksDefault = JSON.parse(
    sessionStorage.getItem("dataStocksDefault")
  );
  useEffect(() => {
  ...
  //load list favorite
  useEffect(() => {
    getListMyFavorite().then((respone) => {
  ...
  const handleDeleteFavorite = (stockName) => {
    let stockDelete = listMyFavorite.find(
  ...
  const portofolioOfUsers = () => {
    ...
    return axiosInstance.post(
      `/api/Stocks/QuadraticForSelectStock?mathWithDailyOrMonth=${false}`,
      data
    );
  };
  ...
  const getStockFromSystem = () => {
    return axiosInstance.post(
      `/api/Stocks/GetListStockName?quantity=${desiredQuantity}`
    );
  };
      ...
      .then((response) => {
        ...
        response.data.stockResults.map((stock) => {
          ...
          if (stock.xValue > 0) {
            labels = [
              ...labels,
              `${stock.nameStock} (${parseValuesTo4Decimal(
                stock.xValue * 100
              )} %)`,
            ];
  ...
  return (
    <>
                      ...
                      <div className="row filter-row">
                        <div className="col-xl-3 col-xxl-6">
                          <input
                            value={stockIdFilter}
                            onChange={(e) => {
                              setStockIdFilter(e.target.value);
                            }}
                            type="text"
                        ...
                        <div className="col-xl-3 col-xxl-6">
                          ...
                          <Button
                            className="me-2"
                            variant="danger"
                            title="Click here to clear filter"
                    ...
                    <Card.Header className="portofolio">
                      <div className="col-xl-3 col-xxl-3 input-container">
                        ...
                        <input
                          ...
                          type="text"
                          className="form-control mb-xl-0 mb-3 input-field"
                          id="exampleFormControlInput1"
                            ...
                            {currentItems.map((stock, index) => {
                              return (
                                <tr key={index}>
                                  ...
                                  {stock.dailyProfit >= 0 ? (
                                    <td className="positive-numbers">
                                      {stock.dailyProfit}
                                    </td>
                                  ) : (
                                    <td className="negative-numbers">
                                      {stock.dailyProfit}
                                    </td>
                                  )}
                                  {parseValuesTo4Decimal(stock.sharpeRatio) >=
                                  0 ? (
                                    <td className="positive-numbers">
                                      {parseValuesTo4Decimal(stock.sharpeRatio)}
                                    </td>
                                    ...
                                    <span className="d-flex justify-content-end">
                                      {listStockPortofolio.length < 25 ? (
                                        checkStockTiker(stock.ticker) ? (
                                          <Link
                                            title="Delete"
                                            className="me-2 btn btn-danger shadow btn-xs sharp"
                                            onClick={() => {
                                              deleteStockPortofolio(
                                                stock.ticker
                                              );
                                            }}
                                          >
                                        ...
                                        <Link
                                          ...
                                          className="me-2 btn btn-danger shadow btn-xs sharp"
                                          onClick={() => {
                                            deleteStockPortofolio(stock.ticker);
                                          }}
                                        >
                                          <i className="fa fa-close color-danger"></i>
                                        </Link>
                                  ...
                                  {listStockNameFavorite.includes(
                                    stock.ticker
                                  ) ? (
                                    <td className="td-favorite">
                                      <i
                                        onClick={() =>
                                          handleDeleteFavorite(stock.ticker)
                                        }
                                    ...
                                    <td>
                                      <i
                                        onClick={() =>
                                          handleAddFavorite(stock.ticker)
                                        }
                                        class="bi bi-heart-fill"
                ...
                <div className="col-xl-12">
                  <div className="card messages ">
                    ...
                    >
                      ...
                      <Link
                        className="btn btn-block btn-primary dlab-load-more btn-portofolio"
                        onClick={(e) => {
                          handleSuggestions();
                          console.log(messageError);
                        }}
                      >
                        Suggestion stock of systems
                      </Link>
                          ...
                          <div className="align-items-center student" key={ind}>
                            <div className="d-flex justify-content-space-between">
                              <div className="d-flex">
                                <span className="me-3 me-lg-2">{ind + 1}</span>
                    ...
                    <div className="card-footer text-center border-0 pt-0">
                      {listStockPortofolio.length < 1 ? (
                        ...
                        <Link
                          className="btn btn-block btn-danger dlab-load-more btn-portofolio"
                          onClick={(e) => {
                            setListStockPortofolio([]);
                          }}
                        >
                          Clear All
                        </Link>
      ...
      <Modal
        className="modal container-fluid modal-portofolio"
        show={showPortofolio}
      >
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="row main-card">
                            ...
                            {loadingOptimizePortofolioView ? (
                              ...
                              <>
                                {dataPortofolio.rr > 0 && (
                                  <h6>
                                    Estimated profit:{" "}
                                    {dataPortofolio.rr.toFixed(4)}%
                                  </h6>
                                )}
                                {dataPortofolio.sum > 0 && (
                                  <h6>
                                    Sum of rate:{" "}
                                    {parseValuesTo4Decimal(dataPortofolio.sum) *
                                      100}
                                    %
                                  </h6>
                                )}
                  ...
                  <div
                    className="col-xxl-5 col-xl-3 wow fadeInUp"
                    data-wow-delay="1s"
                  >
                    <div className="card">
