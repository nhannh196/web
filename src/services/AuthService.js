...
export function signUp(username, email, fullname, password) {
  ...
  return axios.post(
    `https://6618-1-53-195-148.ngrok-free.app/Users/register`,
    postData
  );
}
...
export function login(username, password) {
  ...
  return axios.post(
    `https://6618-1-53-195-148.ngrok-free.app/Users/Login`,
    postData
  );
}

export function getUserDetails(accessToken) {
  return axios.get(`${baseURL}/Users/GetById`, {
    headers: {
...
export function formatError(errorResponse) {
  ...
  switch (errorResponse.message) {
    ...
    case "You are banned from the system.":
      swal("", "You are banned from the system.", "warning", {
        button: "Try Again!",
      });
      break;
    default:
